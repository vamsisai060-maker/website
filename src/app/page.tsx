          ...
          <div className="venue-grid gsap-fade-up">
            <div className="venue-image-cell">
              <div className="venue-image-frame">
                <img src="/venue..jpeg" loading="lazy" width={800} height={600} alt="Aditya Degree College, venue of Astra 2K26" className="venue-image" />
              </div>
            </div>
...
For two days, Astra 2K26 takes over Aditya Degree College in Visakhapatnam — a campus built for learning, where events, innovation and energy come together.              </p>
            ...
            <div className="footer-top-row">
              <div className="footer-logo-col">
                <Link href="/" aria-current="page" className="footer-logo w-inline-block">
                  <img alt="" src="/astra2k26-Photoroom.png" loading="lazy" className="footer-logo-image" />
                </Link>
              </div>
